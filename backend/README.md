...
## Project Structure
    ...
    ├── testconnectors_dev_63233  # Django project configurations
...
1. Clone this repo and `cd testconnectors_dev_63233`
...
2. Clone this repo and `cd testconnectors_dev_63233`
